...
impl Handshaker for SimpleHandshaker {
    ...
    ///
    /// It is important that this is the external port that the peer will be
    /// sending data to. This is relevant if the client employs nat
    /// traversal via upnp or other means.
    fn port(&self) -> u16 {
        6889
    }
