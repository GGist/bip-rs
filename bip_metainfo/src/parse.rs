...
pub fn parse_root_dict<'a, 'b>(root_bencode: &'b Bencode<'a>)
                               -> ParseResult<&'b Dictionary<'a, Bencode<'a>>> {
...
pub fn parse_info_dict<'a, 'b>(root_dict: &'b Dictionary<'a, Bencode<'a>>)
                               -> ParseResult<&'b Dictionary<'a, Bencode<'a>>> {
...
pub fn parse_files_list<'a, 'b>(info_dict: &'b Dictionary<'a, Bencode<'a>>)
                                -> ParseResult<&'b [Bencode<'a>]> {
...
pub fn parse_file_dict<'a, 'b>(file_bencode: &'b Bencode<'a>)
                               -> ParseResult<&'b Dictionary<'a, Bencode<'a>>> {
...
pub fn parse_path_list<'a, 'b>(file_dict: &'b Dictionary<'a, Bencode<'a>>)
                               -> ParseResult<&'b [Bencode<'a>]> {
