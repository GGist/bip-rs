...
fn positive_complete_torrent() {
    ...
    let (good_pieces, recv) = crate::core_loop_with_timeout(
        &mut core,
        500,
        (0, recv),
    ...
    let recv =
        crate::core_loop_with_timeout(&mut core, 500, ((), recv), |_, recv, msg| match msg {
    ...
    let (recv, piece_zero_good) = crate::core_loop_with_timeout(
        ...
        500,
        (false, recv),
        |piece_zero_good, recv, msg| match msg {
