...
impl HandshakeFilter for FilterAllowAll {
    ...
    fn on_ext(&self, _opt_ext: Option<&Extensions>) -> FilterDecision { FilterDecision::Allow }
    fn on_hash(&self, _opt_hash: Option<&InfoHash>) -> FilterDecision { FilterDecision::Allow }
    fn on_pid(&self, _opt_pid: Option<&PeerId>) -> FilterDecision { FilterDecision::Allow }
}
