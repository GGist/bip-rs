...
/// Trait for extended casting of bencode objects and converting conversion
/// errors into application specific errors.
...
/// Trait for casting bencode objects and converting conversion errors into
...
pub trait BConvert {
    ...
    ///
    /// Error key is used to generate an appropriate error message should the
    ...
    /// Combines a lookup operation on the given key with a conversion of the
    /// value, if found, to an integer.
    ...
    /// Combines a lookup operation on the given key with a conversion of the
    /// value, if found, to a series of bytes.
    ...
    /// Combines a lookup operation on the given key with a conversion of the
    /// value, if found, to a UTF-8 string.
    ...
    /// Combines a lookup operation on the given key with a conversion of the
    /// value, if found, to a dictionary.
